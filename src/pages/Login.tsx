  ...
  return (
    <div className="min-h-screen bg-zinc-950 flex flex-col items-center justify-center p-4">
      ...
      >
        ...
        {error && (
          <div className="mb-6 p-4 bg-red-500/10 border border-red-500/20 rounded-xl text-red-500 flex items-center space-x-2 text-left text-sm">
        ...
        <button
          onClick={handleLogin}
          disabled={isLoading}
          className="w-full bg-white text-zinc-900 hover:bg-zinc-100 font-semibold py-3 px-4 rounded-xl flex items-center justify-center space-x-2 transition-colors disabled:opacity-50"
        >
          {isLoading ? (
